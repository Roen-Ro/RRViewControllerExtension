...
#define kNavigationControllerApplyGlobalConfigKey @"globalCfig"
...
{
    UINavigationController *nav = [self initWithRootViewController:rootViewController];
    nav.applyGlobalConfig = apply;
    return nav;
}
...
-(void)mob_navigationTransitionView:(id)obj1 didEndTransition:(BOOL)b fromView:(id)v1 toView:(id)v2
{
